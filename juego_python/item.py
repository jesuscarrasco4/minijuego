...
class Item:     # Esta va a ser la clase que dara forma al item del juego
    def __init__(self, x, y):   # Esta funcion va a recibir un self (como todos los __init__), va a recebir tambien una "x" y una "y"
        ...
        self.y = y
        self.ancho = 40         # Aqui le pondremos el tamaño que tendra nuestro item
        self.alto = 40
        self.velocidad = 5      # La velocidad a la que se movera el item - Al cambiar los FPS, si es necesario, tenemos que cambiar la velocidad
        self.color = "green"     # El colo que tendra el item
        ...
        self.vida = 3
        self.imagen = pygame.image.load("images/item.png")
    ...
    def movimiento(self):   #Lo que hara esta linea, sera mover el item de una sola manera, de arriba hacia abajo
